...
function StudentSection() {
    return (
        <>
            ...
            <div className='white text-black height h-55'>
            ...
            <div className="w-10/12 min-h-[520px] bg-white flex justify-center mx-28 rounded-md relative mt-16 mb-11">
                ...
                <div className="space-y-8 ml-5 mr-5">
                    <h1 className="font-mullish font-bold text-6xl leading-[1.2] my-18">“Tutor4U allowed me to make a living without leaving home!”</h1>
